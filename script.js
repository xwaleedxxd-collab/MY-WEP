// === قاعدة البيانات الموسعة والكاملة 100% بدون أي نقص أو اختصار ===
const wordsDatabase = {
    easy: [
...
function showResultSummary() {
    ...
    document.getElementById('result-user-msg').innerHTML = `أنجزت <strong>${totalTyped}</strong> عناصر كاملة بنجاح! 🎯<br>نسبة دقتك في الكتابة: <strong>${accuracy}%</strong>`;
}
